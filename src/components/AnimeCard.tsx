        ...
        <Link href={`/#/anime/${anime.mal_id}`} className={styles.animeCardLink}>
          <div className={styles.cardCover}>
            <Image
              ...
              alt={displayTitle}
              title={displayTitle}
              width={180} // From CSS .anime-card width
              height={250} // From CSS .anime-card-cover height
              style={{ objectFit: 'cover', display: 'block' }} // Ensure object-fit
              // 'loading="lazy"' is default for next/image
            />
            {anime.rating && (
