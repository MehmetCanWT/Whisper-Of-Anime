    ...
    const AnimeDetailView: React.FC<Props> = ({ anime }) => {
      const placeholderPosterUrl = '/assest/placeholder-poster.png'; // Local placeholder
      const [isTrailerModalOpen, setIsTrailerModalOpen] = useState(false);

      const mainImageUrl = anime.images?.jpg?.large_image_url || anime.images?.jpg?.image_url || placeholderPosterUrl;
      const trailerThumbUrl = anime.trailer?.images?.maximum_image_url || anime.trailer?.images?.medium_image_url;
          ...
          <div className={styles.detailContainer}>
            <div className={styles.posterArea}>
              <Image 
                ...
                className={styles.posterImage} // Ensure CSS handles width and potentially aspect ratio
                width={300} // Corresponds to .posterArea width in CSS
                height={450} // Example height, adjust for aspect ratio
                style={{ objectFit: 'cover', borderRadius: '6px' }}
                priority // Main image on detail page, consider priority
              />
              {trailerThumbUrl && (
                 <div 
                  ...
                  <Image 
                      ...
                      layout="fill" // Let parent div control size with aspect ratio
                      objectFit="cover" // Renamed from object-fit
                  />
            ...
            <div className={styles.infoArea}>
              {/* ... (rest of the info area remains the same) ... */}
