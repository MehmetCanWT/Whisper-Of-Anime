...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    loadAnimeLists(); // Load lists on initial mount of this page
  }, []); 

  // Manage Jikan placeholder visibility based on quote loading state
  useEffect(() => {
  ...
  return (
    // This component now only renders the main page content
