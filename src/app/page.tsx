   ...
   // We no longer directly import getTopAnime etc. here for lists
   ...
   export default function HomePage() {
     ...
     // The anime lists are now fetched by AnimeListSection component itself from our API routes
     // So, no need for topAnime, topAiringAnime, topUpcomingAnime states and useEffect here.
   
     const fetchAnimeDetails = useCallback(async (animeId: string) => {
       if (!animeId) {
           setDetailError("Anime ID is missing for detail view.");
     ...
     useEffect(() => {
       const handleHashChange = () => {
         ...
         if (hash.startsWith('#/anime/')) {
           ...
           } else if (currentView === 'main' && (quoteItem || isLoadingQuote)) {
               setShowJikanPlaceholder(false);
           }
         }
       };
